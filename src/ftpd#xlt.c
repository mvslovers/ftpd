...
/* ================================================================== */
/* IBM Code Page 1047 (Latin-1 / Open Systems) — FTP + UFS default    */
/* ================================================================== */
...
/* ================================================================== */
/* Named codepage pairs                                               */
/* ================================================================== */

ftpd_cp_t ftpd_cp037  = { cp037_atoe,    cp037_etoa    };
ftpd_cp_t ftpd_cp1047 = { ibm1047_atoe,  ibm1047_etoa  };

/* ================================================================== */
/* Active translation table pointers                                  */
/* Default: IBM1047 (FTP protocol, UFS)                               */
/* ================================================================== */

unsigned char *asc2ebc = (unsigned char *)ibm1047_atoe;
unsigned char *ebc2asc = (unsigned char *)ibm1047_etoa;

/* CP037 convenience pointers for MVS dataset translation */
const unsigned char *ftpd_cp037_atoe = cp037_atoe;
const unsigned char *ftpd_cp037_etoa = cp037_etoa;

/* ================================================================== */
/* ftpd_xlat_init — select active codepage at startup                 */
/* ================================================================== */

int
ftpd_xlat_init(const char *codepage)
{
    const unsigned char *atoe;
    const unsigned char *etoa;

    if (!codepage || strcmp(codepage, "IBM1047") == 0) {
        atoe = ibm1047_atoe;
        etoa = ibm1047_etoa;
    }
    else if (strcmp(codepage, "CP037") == 0) {
        atoe = cp037_atoe;
        etoa = cp037_etoa;
    }
    else {
        ftpd_log_wto("FTPD085E Unknown codepage \"%s\", using IBM1047",
                     codepage);
        atoe = ibm1047_atoe;
        etoa = ibm1047_etoa;
        return -1;
...
/* In-place ASCII -> EBCDIC translation (uses active tables) */
void
...
/* In-place EBCDIC -> ASCII translation (uses active tables) */
void
