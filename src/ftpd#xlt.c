...
** Same tables as HTTPD (httpxlat.c ibm1047_atoe / ibm1047_etoa).
**
** NL/LF mapping — modified from pure IBM-1047:
**   ASCII LF  (0x0A) -> EBCDIC NEL (0x15)  <- for c2asm370 '\n'
...
** 0x15.  Mapping ASCII LF (0x0A) to NEL (0x15) ensures roundtrip
** fidelity.
*/
#include "ftpd#xlt.h"
